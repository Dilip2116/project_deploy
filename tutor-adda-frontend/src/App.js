...
{/*     
      ...
      <Header />
        <Routes>
              ...
              <Route  path="/student_scheduler" element={<StudentSchedule />} />
          ...
          <Route   path="/admin_login" element={<Admin_Login1 />} />
          <Route  path="/about" element={<AboutUs />} />
          <Route  path="/contact" element={<Contact />} />
          <Route   path="/faq" element={<FAQ />} />
          <Route   path="/course" element={<Courses />} />
          <Route  path="/coursedetails" element={<CousreDetails />} />
          <Route   path="/forgotpswd" element={<Forget_Password />} />
          <Route   path="/student_register" element={<StudentRegistrationForm />} />
          <Route  path="/teacher_register" element={<TeacherRegistrationForm />} />
        </Routes>
      <BottomBar />
      </BrowserRouter> 
       */}
